...
const en: Record<CopyKey, string> = {
  ...
  'login.subtitle': "We'll send a secure sign-in link to your email. No password needed.",
  'login.emailLabel': 'EMAIL ADDRESS',
  'login.submit': 'Send sign-in link →',
  'login.sending': 'Sending link…',
  'login.error': 'We could not send the sign-in link. Confirm your enrollment email and try again.',
  'verify.heading': 'Check your email.',
  'verify.subtitle': 'Sign-in link sent to {email} · expires shortly · one use only.',
  'verify.codeLabel': 'SIGN-IN LINK',
  'verify.submit': 'Continue →',
  'verify.verifying': 'Verifying…',
  'verify.error': 'That sign-in link is invalid or expired. Request a new one and try again.',
  'verify.resend': 'Resend sign-in link',
  'verify.invalidCode': 'Open the sign-in link from your email to continue.',
  'verify.sentNew': 'A new sign-in link was sent.',
  'verify.resendFailed': 'Unable to resend right now. Please wait and try again.',
  'verify.codeInputAria': 'Sign-in link status'
}
...
const es: Record<CopyKey, string> = {
  ...
  'login.subtitle': 'Te enviaremos un enlace seguro de acceso. Sin contraseña.',
  'login.emailLabel': 'DIRECCIÓN DE EMAIL',
  'login.submit': 'Enviar enlace de acceso →',
  'login.sending': 'Enviando enlace…',
  'login.error': 'No pudimos enviar el enlace. Confirma tu email de inscripción.',
  'verify.heading': 'Revisa tu email.',
  'verify.subtitle': 'Enlace enviado a {email} · expira pronto · un solo uso.',
  'verify.codeLabel': 'ENLACE DE ACCESO',
  'verify.submit': 'Continuar →',
  'verify.verifying': 'Verificando…',
  'verify.error': 'El enlace es inválido o expiró. Pide uno nuevo.',
  'verify.resend': 'Reenviar enlace',
  'verify.invalidCode': 'Abre el enlace de acceso desde tu email para continuar.',
  'verify.sentNew': 'Se envió un nuevo enlace.',
  'verify.resendFailed': 'No se pudo reenviar ahora. Espera un momento.',
  'verify.codeInputAria': 'Estado del enlace de acceso'
}
