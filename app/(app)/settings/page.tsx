  ...
  return (
    <div className="shell">
      ...
      <main className="main">
        ...
        <h1>Set your environment.</h1>

        <section className="card" style={{ marginTop: 32 }}>
          <p className="eyebrow">STYLE PRESET</p>
          <p className="muted">The structure stays the same. The way it feels is yours.</p>
          <div
            style={{
              display: 'grid',
            ...
            {presets.map(key => {
              ...
              return (
                ...
                >
                  ...
                  <b>{t.name}</b>
                  <small style={{ display: 'block', color: t.muted, marginTop: 8 }}>
                    {t.density} · {t.font}
                  </small>
                  <i style={{ display: 'block', background: t.accent, width: 24, height: 4, marginTop: 22 }} />
                </button>
              )
            })}
          </div>
        ...
        <section className="card" style={{ marginTop: 15 }}>
          ...
          {!prefsLoaded ? (
            ...
            <div style={{ display: 'grid', gap: 12, marginTop: 12 }}>
              ...
              {prefsMsg && (
                <p className="muted" style={{ color: prefsMsg.kind === 'err' ? '#ff8b82' : 'var(--accent)', fontSize: 12 }}>
                  {prefsMsg.text}
                </p>
              )}
              {prefsSaving && <p className="muted" style={{ fontSize: 12 }}>Saving…</p>}
            </div>
          )}
        </section>
        ...
        <section className="grid" style={{ marginTop: 15 }}>
          ...
          <div className="card">
            ...
            <Link href="/settings/devices">Manage active devices →</Link>
          </div>
        </section>
      </main>
    </div>
